...
# Like build.sh, but with -DDOWNLOAD_MODELS=OFF and -DDOWNLOAD_IMAGES=OFF.
...
cmake -S ./ -B $build_dir -DCMAKE_INSTALL_PREFIX=$install_dir -DCMAKE_BUILD_TYPE=Release -DCMAKE_VERBOSE_MAKEFILE:BOOL=ON -DDOWNLOAD_MODELS=OFF -DDOWNLOAD_IMAGES=OFF
